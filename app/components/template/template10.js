...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >lga]bg btf{
              g++=============${props.dartanum}=================ldlt===========${props.Miti}=============</font
            ></font
          >
        </p>
      ...
      <table width="612" cellpadding="7" cellspacing="0">
        ...
        ${props.showJaggaBibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">#=;+zf]wg x'g] lja/0f</font></font
          >
        </p>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>hUufsf] laa/0f </b></font></font
          >
        </p>
        <table width="666" cellpadding="7" cellspacing="0">
          <colgroup>
            <col width="44" />
            <col width="45" />
            <col width="86" />
          ...
          <tbody>
            <tr valign="TOP">
              ...
              >
                <p align="CENTER">
                  <font face="Preeti, serif"
                    ><font size="4"><b>ePsf]</b></font></font
                  >
                </p>
              </td>
              <td
              ...
              >
                <p align="CENTER">
                  <font face="Preeti, serif"
                    ><font size="4"><b>x'g'kg{]</b></font></font
                  >
                </p>
              </td>
            </tr>
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
      ${props.showJaggaFoundArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>hUufwgLsf] laa/0f</b></font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
          ...
          <tbody>
            ...
            ${props.jaggafoundArray.map(function (each) {
        return (`<tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggafoundNaamThar}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggafoundNagariktaNumber}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggafoundNagariktaJariMiti}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggafoundNagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggafoundBabuPitakoNaam}</p>
              </td>
              <td
                width="77"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
            ...
            ${props.jaggaactualArray.map(function (each) {
        return (`<tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualNaamThar}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualNagariktaNumber}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualNagariktaJariMiti}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualNagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualBabuPitakoNaam}</p>
              </td>
              <td
                width="77"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaactualBajeSasuraNaam}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        ...
        ${props.showSipharisArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">$=;+zf]wgsf] nflu l;kmfl/; lbg] lgsfo</font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
        ...
        return (`<tr valign="TOP">
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4"
                      >=========${each.sipharisNaam}========ufpFkflnsf÷gu/kflnsf ======${each.sipharisOdaNumber}======g++=j8f
                      sfof{no</font
                    ></font
                  >
                </p>
        ...
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">^=tfd]nLsf] Aoxf]/f M ${props.behora1}</font></font
          >
        </p>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
        ...
        <ul>
          <li>
          ${props.sanglangpramandArray.map(function (each) {
        return (`<p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >===============${each.sanglangpramandNagarpalikaGaupalika}====================== ufpFkflnsf÷gu/kflnsf
                  =======${each.sanglangpramandWadaNumber}======j8f sfof{nosf] r
                  g++============${each.sanglangpramandChaNumber}==================sf] ls6fgL ;+zf]wg
                  kq</font
                ></font
              >
            </p>`);
        ...
        <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
          ...
          <font face="Preeti, serif"
            ><font size="4"
              ...
              x]bf{ lgj]bssf] dfu adf]lhd ;+zf]wg
            </font></font
          ><font face="Preeti, serif"
            ><font size="4"
              >b:t'/ ?===${props.rakam}==== a'emL b]xfosf] hUuf b]xfo adf]lhd ;+zf]wg x'g plrt
              b]vL lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>
        ${props.showSansodhanArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>;+zf]wg ePsf] hUufsf] lja/0f</b></font></font
          >
        </p>
        <table width="618" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.sansodhanArray.map(function (each) {
        return (`<tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sansodhanJilla}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sansodhanGabisa}</p>
              </td>
              <td
                width="136"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sansodhanOda}</p>
              </td>
              <td
                width="66"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sansodhanKirta}</p>
              </td>
              <td
                width="187"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sansodhanChetrafhal}</p>
              </td>
               </tr>`);
    })}
          </tbody>
        ...
        ${props.showJaggaDhaniBibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>;+zf]wg ePsf] </b></font></font
          ><font face="Preeti, serif"
            ><font size="4"><b>hUufwgLsf] laa/0f</b></font></font
          >
        </p>
