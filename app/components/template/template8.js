...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in"><font face="Preeti, serif"><font size="4">ljifo
          M</font></font><font face="Preeti, serif"><font size="4"> df]xL</font></font><font face="Preeti, serif"><font size="4">
          gfd;f/L .</font></font></p>
        ...
        ${props.showJaggabibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">#=df]xL gfd;f/L x'g] hUufsf] lja/0f</font></font
          >
        </p>
        ...
        return (`<tr valign="TOP">
              ...
              style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
            >
              <p><br />${each.jaggabibaranArraynaam}</p>
            </td>
        ...
        ${props.showNamsariArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >$= df]xL gfd;f/Lsf nflu xsjfnfsf] laa/0f</font
            ></font
          >
        </p>
        ...
        ${props.showSipharisArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >%=df]xL gfd;f/Lsf] nflu km};nf ug{] lgsfo</font
            ></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
            ...
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  ...
                  g++======${each.sanlaganChaNumber}======ldlt========${each.sanlaganMiti}==========sf] df]xL gfd;f/L
                  km};nf</font
                ></font
              >
            </p>`);
        ...
        <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"
              >b]xfosf] hUuf b]xfosf AolQmsf gfddf df]xL gfd;f/L x'g plrt b]vL
              lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>
        ${props.showNamSariJagaArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b>df]xL gfd;f/L x'g] hUufsf] lja/0f</b></font
            ></font
          >
        </p>
        <table width="594" cellpadding="7" cellspacing="0">
          <colgroup>
            <col width="89" />
            <col width="68" />
            <col width="136" />
          ...
          <tbody>
            ...
            ${props.namSariJagaArray.map(function (each) {
        return (`<tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
        ...
        ${props.showJaggaDhaniBibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b>df]xL gfd;f/L kl5 sfod x'g] df]xLsf] laa/0f</b></font
            ></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
