...
">
        ...
        <p class="western" style="margin-left: -0.1in;margin-bottom: 0in;line-height: 100%;margin-top: 8px;">
          <font face="Preeti, serif">
            <font size="2" style="font-size: 10pt">r =g+= </font>
          </font>
        </p>
      </div>
...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"><font size="4">ljifo M</font></font
          ><font face="Preeti, serif"
            ><font size="4"> cbfntsf] km};nf adf]lhd afF8kmfF8 </font></font
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >lga]bg btf{
              g++=====${props.dartaNumber}======ldlt=====${props.dartaMiti}======</font
            ></font
          >
        </p>
          ...
          <tbody>
            ...
            ${props.nibedakArray.map(function(each){
              ...
              <td
                width="84"
                bgcolor="#ffffff"
                style="border: 1px solid #000001; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"> <font face="Preeti, serif"
                    ><font size="4">${each.naamThar}</font></font
                  ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                ><font size="4">${each.nagariktaNumber}</font></font
              ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                ><font size="4">${each.nagariktaJariJilla}</font></font
              ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                ><font size="4">${each.babuPitakoNaam}</font></font
              ></p>
              </td>
              <td
                width="88"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                ><font size="4">${each.bajeSasuraNaam}</font></font
              ></p>
              </td>
              <td
                width="77"
        ...
        <table width="612" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.jaggaArray.map(function(each){
              return (` <tr valign="TOP">
              <td
                width="84"
                bgcolor="#ffffff"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.nagariktaJariMiti}</font></font
               ></p>
              </td>
              <td
                width="87"
        ...
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">#=df]xLsf] lja/0f</font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
          ...
          <tbody>
            ...
            ${props.mohiArray.map(function(each){
              return (` <tr valign="TOP">
              <td
                width="84"
                bgcolor="#ffffff"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiNaamThar}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiNagariktaNumber}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiNagariktaJariMiti}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiNagariktaJariJilla}</font></font
               ></p>
              </td>
              <td
                width="88"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiBabuPitakoNaam}</font></font
                 ></p>
              </td>
              <td
                width="77"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohiBajeSasuraNaam}</font></font
               ></p>
              </td>
            </tr>`);
            })}
        ...
        <p style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"> cbfntsf] km};nf adf]lhd afF8kmfF8 </font></font
          ><font face="Preeti, serif"
            ><font size="4">x'g] hUufsf] lja/0f</font></font
          >
        </p>
          ...
          <tbody>
            <tr valign="TOP">
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">Dff]xLsf] gfd</font></font
                  >
                </p>
              </td>
            </tr>
            ${props.mohibadfordArray.map(function(each){
              return (` <tr valign="TOP">
              <td
                width="84"
                bgcolor="#ffffff"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordJilla}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordGabisa}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordWadaNumberSitNumber}</font></font
               ></p>
              </td>
              <td
                width="87"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordKitaNumber}</font></font
               ></p>
              </td>
              <td
                width="88"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordKsytrafal}</font></font
                 ></p>
              </td>
              <td
                width="77"
              ...
              >
                <p class="western"><font face="Preeti, serif"
                 ><font size="4">${each.mohibadfordMohiNaam}</font></font
               ></p>
              </td>
            </tr>`);
            })}
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"><font size="4">%=</font></font
          ><font face="Preeti, serif"><font size="4"> km};nf</font></font
          ><font face="Preeti, serif"><font size="4"> ug{] lgsfo</font></font>
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
            <col width="249" />
          ...
          <tbody>
            ...
            ${props.nikayaArray.map(function(each){return(`<tr valign="TOP">
              <td
                width="249"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p>
                  <font color="#ff0000"
                    ><font face="Preeti, serif"
                      ><font size="4"
                        >=====${each.nikayaJillaAdalat}=========lhNnf cbfnt,====${each.nikayaUcchaAdalat}======pRr
                        cbfnt,======${each.nikayaSarbacchaAdalat}============;jf{"{"}]Rr cbftn</font
                      ></font
                    ></font
                  >
                </p>
              ...
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><font face="Preeti, serif"><font size="4" style="font-size: 16pt">${each.nikayaJilla}</font></font></p>
              </td>
              <td
                width="88"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><font face="Preeti, serif"><font size="4" style="font-size: 16pt">${each.nikayaPatraNumber}</font></font></p>
              </td>
              <td
                width="141"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><font face="Preeti, serif"><font size="4" style="font-size: 16pt">${each.nikayaMiti}</font></font></p>
              </td>
            </tr>`);})}
          </tbody>
        </table>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ...
              =========${props.phatBataJaggaKo}========${props.behora}===========hUufsf] ;|]:tf sfod 5 /f]Ssf
        ...
        <ul>
          ${props.sanglangaPramandArray.map(function(each){return(
           `<li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >======${each.sanglangaPramandJillaAdalat}========lhNnf cbfnt,====${each.sanglangaPramandUcchaAdalat}======pRr
                  cbfnt,========${each.sanglangaPramandSarbachhaAdalat}==========;jf{]Rr cbftnsf] r g++ ====${each.sanglangaPramandChaNumber}====== sf]
                  =====${each.sanglangaPramandMiti}=======ldlt========${each.sanglangaChalanPurji}==========sf] rng k'hL{ ÷cfb]z÷
                </font></font
              ><font face="Preeti, serif"
                ><font size="4">kq;fy k|fKt</font></font
              ><font face="Preeti, serif"
                ><font size="4"> km};nf k|lt .</font></font
              >
            </p>
          </li>`
          )})}
          ...
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">gful/stf k|df0fkqsf] k|ltlnkL</font></font
              >
            </p>
          </li>
          <li>
          ...
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">hUufwgL btf{ k|df0f kq</font></font
              >
            </p>
          </li>
        </ul>
        <p align="JUSTIFY" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b
                >======${props.sanglangaPramandArray[0].sanglangaPramandJillaAdalat}========lhNnf cbfnt,===${props.sanglangaPramandArray[0].sanglangaPramandUcchaAdalat}=======pRr
                cbfnt,======${props.sanglangaPramandArray[0].sanglangaPramandSarbachhaAdalat}============;jf{]Rr cbftnsf] km};nf adf]lhd bflvn
                vf/]h x'g] hUufsf] lja/0f</b
              ></font
            ></font
          >
        </p>
          ...
          <tbody>
            <tr valign="TOP">
              ...
              >
                <p align="CENTER">
                  <font face="Preeti, serif"
                    ><font size="4">hUufsf] ;fljs lja/0f</font></font
                  >
                </p>
              </td>
              <td
              ...
              >
                <p align="CENTER">
                  <font face="Preeti, serif"
                    ><font size="4">hUufsf] xfnsf] lja/0f</font></font
                  >
                </p>
              </td>
            </tr>
            <tr valign="TOP">
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">;fljs lsQf g++</font></font
                  >
                </p>
              </td>
              <td
              ...
              >
                <p>
                  <font face="Preeti, serif"><font size="4">Tfkm{</font></font>
                </p>
              </td>
              <td
                width="40"
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">xfnsf] lsQf g++</font></font
                  >
                </p>
              </td>
              <td
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">ca sfod x'g] hUUfwgLsf] gfd</font></font
                  >
                </p>
              </td>
            </tr>
            ${props.dakhilArray.map(function(each){
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">${each.dakhilJilla}</font></font
                  >
                </p>
              </td>
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilGabisa}</font></font
              ></p>
              </td>
              <td
                width="51"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilOda}</font></font
              ></p>
              </td>
              <td
                width="40"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilSabik}</font></font
              ></p>
              </td>
              <td
                width="41"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilChetrafal}</font></font
              ></p>
              </td>
              <td
                width="38"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilTarfha}</font></font
              ></p>
              </td>
              <td
                width="40"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilKirta}</font></font
              ></p>
              </td>
              <td
                width="41"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakhilChetrafal1}</font></font
              ></p>
              </td>
              <td
                width="209"
              ...
              >
                <p> <font face="Preeti, serif"
                ><font size="4">${each.dakilKayam}</font></font
              ></p>
              </td>
            </tr>
              `)
        ...
        <p align="JUSTIFY" style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4">b]xfosf] hUuf b]xfosf AolQmsf gfddf </font></font
          ><font face="Preeti, serif"
            ><font size="4"
              ><b
              >====${props.jillaAdalat1}==========lhNnf cbfnt,====${props.uchhaAdalat1}======pRr
                cbfnt,=======${props.sarbacchaAdalat1}===========;jf{]Rr cbftnsf] km};nf adf]lhd bflvn
                vf/]h
              </b></font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"
              >x'g plrt b]vL lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b
                >&gt;L ============${props.naam1}======================sf] gfddf sfod x'g]
                lsQf</b
              ></font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"><b> hUufsf] lja/0f</b></font></font
          >
        </p>
        <table width="580" cellpadding="7" cellspacing="0">
          <colgroup>
            <col width="89" />
            <col width="68" />
            <col width="64" />
          ...
          <tbody>
            ...
            ${props.kirtaArray.map(function(each){return(`
            <tr valign="TOP">
            <td
              width="89"
              style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaJilla}</font></font
              ></p>
            </td>
            <td
              width="68"
            ...
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaGabisa}</font></font
              ></p>
            </td>
            <td
              colspan="2"
            ...
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaOda}</font></font
              ></p>
            </td>
            <td
              width="66"
            ...
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaSabik}</font></font
              ></p>
            </td>
            <td
              width="68"
            ...
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaKirtaNumber}</font></font
              ></p>
            </td>
            <td
              width="67"
            ...
            >
              <p><font face="Preeti, serif"
                ><font size="4">${each.kirtaChetrafal}</font></font
              ></p>
            </td>
          </tr>
            `)})}
