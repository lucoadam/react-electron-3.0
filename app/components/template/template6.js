...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">ljifo M gfd;f/L .</font></font
          >
        </p>
      ...
      ${props.showJaggabibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">#=gfd;f/L x'g] hUufsf] lja/0f</font></font
          >
        </p>
        ...
        ${props.showNamSariArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >$= gfd;f/Lsf nflu of]Uo ;a} xsjfnfsf] laa/0f</font
            ></font
          >
        </p>
          ...
          <tbody>
            <tr valign="TOP">
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">hUUffwgL;Fusf] gftf</font></font
                  >
                </p>
              </td>
            </tr>
            ${props.namsariArray.map(function (each) {
        return (` <tr valign="TOP">
              <td
                width="64"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariNaamThar}</p>
              </td>
              <td
                width="72"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariNagariktaNumber}</p>
              </td>
              <td
                width="72"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariNagariktaJariMiti}</p>
              </td>
              <td
                width="72"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariNagariktaJariJilla}</p>
              </td>
              <td
                width="78"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariBabuPitakoNaam}</p>
              </td>
              <td
                width="83"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariBajeSasuraNaam}</p>
              </td>
              <td
                width="82"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namsariNata}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        ...
        ${props.showHakArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >%= ck'tfnL :jLsf/ gu/L d~h'/Lgfdf lbg] xsjfnfsf] laa/0f</font
            ></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.hakArray.map(function (each) {
        return (` <tr valign="TOP">
              <td
                width="69"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakNaamThar}</p>
              </td>
              <td
                width="76"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakNagariktaNumber}</p>
              </td>
              <td
                width="76"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakNagariktaJariMiti}</p>
              </td>
              <td
                width="76"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakNagariktaJariJilla}</p>
              </td>
              <td
                width="67"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakBabuPitakoNaam}</p>
              </td>
              <td
                width="77"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.hakBajeSasuraNaam}</p>
              </td>
              <td
                width="70"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
    ...
    <section class="sheet padding-10mm">
      ...
      ${props.showSipharisArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">^=gfd;f/Lsf] nflu l;kmfl/; lbg] lgsfo</font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
        ...
        return (` <tr valign="TOP">
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4"
                      >============${each.sipharisNaam}================ufpFkflnsf÷gu/kflnsf
                      =======${each.sipharisOdaNumber}=====g++=j8f sfof{no</font
                    ></font
                  >
                </p>
              </td> 
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sipharisJilla}</p>
              </td>
              <td
                width="87"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sipharisChaNumber}</p>
              </td>
              <td
                width="139"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.sipharisMiti}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        ...
        <ul>
          <li>
          ${props.firstPartArray.map(function (each) {
            return (`<p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >============${each.nagarpalika}==============ufpFkflnsf÷gu/kflnsf
                  =======${each.odaNumber}======j8f sfof{nosf] r
                  g++=====${each.chaNumber}=======ldlt=========${each.Miti}=========sf] gfd;f/L ls6fgL
                  l;kmfl/; kq</font
                ></font
              >
            </p>`);
          ...
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">d[To'btf{ k|df0fkqsf] k|ltlnkL</font></font
              >
            </p>
          </li>
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">a]kQf ePsf] k|df0f tyf l;kmfl/;kq</font></font
              >
            </p>
          </li>
          <li>
          ${props.secondPartArray.map(function (each) {
            return (` <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >=============${each.nagarpalika1}=============ufpFkflnsf÷gu/kflnsf
                  =======${each.odaNumber1}======j8f sfof{nosf] r
                  g++======${each.chaNumber1}======ldlt========${each.Miti1}==========sf] gftf k|df0fkq</font
                ></font
              >
              </p>`);
            })}
        ...
        <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ...
              x]bf{ lgj]bs d'n'sL b]jfgL -;+lxtf</font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"
              >_ P]g,@)&amp;$ sf] bkmf @#( sf] a'bf g++ ===${props.budaNumber}==sf] xsjfnfsf]
              k|fyldstfdf k/]sf]n] lgodfg';f/sf] gfd;f/L b:t'/ ?=====${props.rakam}========
              a'emL b]xfosf] hUuf b]xfosf AolQmsf gfddf gfd;f/L x'g plrt b]vL
              lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>
        ${props.showNamSari1Array ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>gfd;f/L x'g] hUufsf] lja/0f</b></font></font
          >
        </p>
        <table width="618" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.namSari1Array.map(function (each) {
        return (` <tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namSariJilla}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namSariGabisa}</p>
              </td>
              <td
                width="136"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namSariOda}</p>
              </td>
              <td
                width="66"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namSariKirta}</p>
              </td>
              <td
                width="187"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.namSariChetrafhal}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        </table>`) : ('')}
        ${props.showJaggaDhaniBibaranArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b>gfd;f/L kl5 sfod x'g] hUufwgLsf] laa/0f</b></font
            ></font
          >
        </p>
        <table width="623" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.jaggaDhaniBibaranArray.map(function (each) {
        return (` <tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranNaamThar}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranNagariktaNumber}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranNagariktaJariMiti}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranNagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranBabuPitakoNaam}</p>
              </td>
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.jaggaDhaniBibaranBajeSasuraNaam}</p>
              </td>
            </tr>
            </tr>`);
    })}
