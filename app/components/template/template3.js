...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"><font size="4"> 3/ sfod </font></font
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >lga]bg btf{
              g++=======${props.dartanum1}===========ldlt======${props.dartaMiti}=========</font
            ></font
          >
        </p>
    ...
    <table width="612" cellpadding="7" cellspacing="0">
      ...
      <tbody>
        ...
        ${props.showGharjaggaArray?(`<p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">#=</font></font
        ><font face="Preeti, serif"><font size="4"> 3/ sfod</font></font
        ><font face="Preeti, serif"
      ...
      <table width="600" cellpadding="7" cellspacing="0">
        ...
        <tbody>
          ...
          ${props.gharjaggaArray.map(function(each){
            ...
            >
              <p><font face="Preeti, serif"
                  ><font size="4">${each.jilla}</font></font
                ></p>
            </td>
            <td
              width="68"
            ...
            >
              <p><font face="Preeti, serif"
                  ><font size="4">${each.gabisa}</font></font
                ></p>
            </td>
            <td
              width="136"
            ...
            >
              <p><font face="Preeti, serif"
                  ><font size="4">${each.oda}</font></font
                ></p>
            </td>
            <td
              width="66"
            ...
            >
              <p><font face="Preeti, serif"
                  ><font size="4">${each.kirta}</font></font
                ></p>
            </td>
            <td
              width="169"
            ...
            >
              <p><font face="Preeti, serif"
                  ><font size="4">${each.chetrafhal}</font></font
                ></p>
            </td>
          </tr>`);
          })}
        ...
        ${props.showGharsipharisArray?(`
        <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"
          ><font size="4">$=3/ sfodsf] nflu l;kmfl/; lbg] lgsfo</font></font
        >
      </p>
      <table width="612" cellpadding="7" cellspacing="0">
        <colgroup>
        ...
        <tbody>
          ...
          ${props.gharsipharisArray.map(function(each){
            return (`
            <tr valign="TOP">
            <td
              width="249"
            ...
            >
              <p>
                <font face="Preeti, serif"
                  ><font size="4"
                    >=====${each.gharsipharisNaam}=======gu/kflnsf</font
                  ></font
                >
              </p>
            </td>
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
        ...
        <ul>
        ${props.showSanglangaPramandArray?(`
          ${props.sanglangaPramandArray.map(function(each){
            return (`
            <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >=====${each.sanglangapramanNagarpalika}=====gu/kflnsfsf] sf] r
                  g++===${each.sanglangapramanChanumber}=====ldlt====${each.sanglangapramanMitti}===== 3/ lgdf{0f ;DkGg
                  l;kmfl/; kq</font
                ></font
              >
            </p>
        ...
        <ul>
          ...
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">3/ lgdf{0f ;DkGg l;kmfl/; k|df0fkq</font></font
              >
            </p>
          </li>
        </ul>
        ...
        <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"
              >b]xfosf] hUuf b]xfosf AolQmsf gfddf lgodfg';f/sf]
              b:t'/======${props.dastur}=====a'emL hUufwgL btf{ k|df0f k'hf{,;|]itdf 3/
              sfod plrt b]vL lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"><b>3/ sfod x'g] lsQf</b></font></font
          ><font face="Preeti, serif"
            ><font size="4"><b> hUufsf] lja/0f</b></font></font
          >
        </p>
        ${props.showKaryalayanirmanArray?(`
        <table width="540" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="89" />
          <col width="68" />
          <col width="136" />
        ...
        <tbody>
          ...
          ${props.karyalayanirmanArray.map(function(each){
            return (` <tr valign="TOP">
            <td
              width="89"
              style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
