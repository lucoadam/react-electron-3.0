...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"> df]xL afF8kmfF8 bflvn vf/]h </font></font
        ...
        ${props.showMohiArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
        ...
        return (` <tr valign="TOP">
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiBabuPitakoNaam}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiBajeSasuraNaam}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiNaamThar}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiNagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiNagariktaJariMiti}</p>
              </td>
              <td
                width="77"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohiNagariktaNumber}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        </table>`) : ('')}
        ${props.showMohibadfordArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"><font size="4">$=</font></font
          ><font face="Preeti, serif"
            ><font size="4"> df]xL afF8kmfF8 bflvn vf/]h </font></font
          ><font face="Preeti, serif"
        ...
        return (` <tr valign="TOP">
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordJilla}</p>
              </td>
              <td
                width="62"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordGabisa}</p>
              </td>
              <td
                width="120"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordWadaNumberSitNumber}</p>
              </td>
              <td
                width="59"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordKitaNumber}</p>
              </td>
              <td
                width="113"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordKsytrafal}</p>
              </td>
              <td
                width="105"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.mohibadfordMohiNaam}</p>
              </td>
              </tr>`);
    })}
          </tbody>
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
      ${props.showNikayaArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"><font size="4">%=</font></font
          ><font face="Preeti, serif"
            ><font size="4"> df]xL afF8kmfF8 bflvn vf/]hsf] </font></font
          ><font face="Preeti, serif"
            ><font size="4"> nflu km};nf ug{] lgsfo</font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
          ...
          <tbody>
            ...
            ${props.nikayaArray.map(function (each) {
        return (` <tr valign="TOP">
              <td
                width="249"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4">${each.nikayaJilla}</font></font
                  >
                </p>
              </td>
              <td
        ...
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ...
              =================${props.phatbatajaggako}=====================hUufsf] ;|]:tf sfod 5 /f]Ssf
        ...
        <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4">&amp;=tfd]nLsf] Aoxf]/f M ${props.behora}</font></font
          >
        </p>
        <p style="margin-bottom: 0.11in">
        ...
        <ul>
          <li>
          ${props.sanlaganArray.map(function (each) {
        return (`<p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4"
                  >e"ld;'wf/ tyf dfnkf]t sfof{no,l8NnLahf/ sf] r
                  g++======${each.sanlaganChaNumber}======ldlt========${each.sanlaganMiti}==========sf]
                </font></font
              ><font face="Preeti, serif"
                ><font size="4">df]xL afF8kmfF8sf]</font></font
        ...
        <p align="JUSTIFY" style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"
              >e"ld;'wf/ tyf dfnkf]t sfof{no,l8NnLahf/sf] km};nf adf]lhd df]xL
              afF8kmfF8 bflvn vf/]h</font
            ></font
          ><font face="Preeti, serif"
            ><font size="4">
        ...
        ${props.showKirtajaggaArray ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b
                >df]xL &gt;L ===============${props.naam}===================sf] gfddf sfod
                x'g] lsQf</b
              ></font
            ></font
          ><font face="Preeti, serif"
        ...
        <table width="580" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.kirtajaggaArray.map(function (each) {
        return (`<tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaJilla}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaGabisa}</p>
              </td>
              <td
                colspan="2"
                width="136"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaOda}</p>
              </td>
              <td
                width="66"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaSabik}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaKirtanum}</p>
              </td>
              <td
                width="67"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajaggaChetrafhal}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        </table>`) : ('')}
        ${props.showKirtajagga1Array ? (`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              ><b
                >= hUufwgLsf] &gt;L============${props.naam2}==================sf] gfddf sfod
                x'g] hUufsf] laa/0f</b
              ></font
            ></font
          >
        ...
        <table width="580" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            <tr valign="TOP">
              ...
              ${props.kirtajagga1Array.map(function (each) {
        return (`  <tr valign="TOP">
              <td
                width="89"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Jilla}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Gabisa}</p>
              </td>
              <td
                colspan="2"
                width="136"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Oda}</p>
              </td>
              <td
                width="66"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Sabik}</p>
              </td>
              <td
                width="68"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Kirtanum}</p>
              </td>
              <td
                width="67"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p><br />${each.kirtajagga1Chetrafhal}</p>
              </td>
              </tr>`);
    })}
          </tbody>
