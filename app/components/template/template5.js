...
"
        ...
        return (`<tr valign="TOP">
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nibedakNaamThar}</p>
              </td>
              <td
                width="90"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nibedakNagariktaNumber}</p>
              </td>
              <td
                width="90"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nibedakNagariktaJariMiti}</p>
              </td>
              <td
                width="90"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nibedakNagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                bgcolor="#ffffff"
              ...
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nibedakBajeSasuraNaam}</p>
              </td>
              </tr>`);
    })}
          </tbody>
        </table>`) : ('')}
        ${props.showJaggaArray ? (`
...
${props.jaggabibaranArray.map(function (each) {
        ...
        <table width="612" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.nirnayaArray.map(function (each) {
              return `<tr align="TOP">
              <td
                width="261"
                bgcolor="#ffffff"
              ...
              >
                <p class="western">
                  <font face="Preeti, serif"
                  >                    <font size="4">${each.nirnayaNaam}</font></font
              ...
              >
                <p class="western">
                  <font face="Preeti, serif"
                    ><font size="4">${each.nirnayaJilla}</font></font
                  >
                </p>
              </td>
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nirnayaChaNumber}</p>
              </td>
              <td
                width="134"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.nirnayaDate}</p>
              </td>
              </tr>`;
            })}
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
            ...
            <p style="margin-bottom: 0.11in; line-height: 107%">
              <font face="Preeti, serif"
                ><font size="4"
                  ...
                  g++==============${props.bibaranArray[0].chaNumber}================sf] kq</font
                ></font
              >
            </p>
          </li>
        ...
        >
          <font face="Preeti, serif"
            ><font size="4"
              ...
              x]bf{ a9 ePsf] If]qkmn===========${props.chetrafhal}===========sf] lj=;+= @)@$ ;fn
              b]lvsf] dfnkf]t
            </font></font
          ><font face="Preeti, serif"
            ><font size="4"
        ...
        ${props.showKaryalayanirmanArray ? (`<p style="margin-left: 0.5in; margin-bottom: 0.11in; line-height: 107%">
          <font face="Preeti, serif"
            ><font size="4"
          ...
          <tbody>
            ...
            ${props.karyalayanirmanArray.map(function (each) {
              ...
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanJilla}</p>
              </td>
              <td
                width="65"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanGabisa}</p>
              </td>
              <td
                width="80"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanWadaNumberSitNumber}</p>
              </td>
              <td
                width="45"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanKitaNumber}</p>
              </td>
              <td
                width="69"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanKsytrafal}</p>
              </td>
              <td
                width="76"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanKsytrafal1}</p>
              </td>
              <td
                width="105"
                bgcolor="#ffffff"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                <p class="western"><br />${each.karyalayanirmanKsytrafal2}</p>
              </td>
              </tr>`;
            })}
