...
"
        ...
        <p align="CENTER" style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"> hUufwgL btf{ k|df0f k'hf{sf] k|ltnLkL </font></font
        ...
        <table width="612" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.nibedakArray.map(function(each){return `
            <tr valign="TOP">
              ...
              <td
                ...
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                 <p>${each.nagariktaNumber}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                 <p>${each.nagariktaJariMiti}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                 <p>${each.nagariktaJariJilla}</p>
              </td>
              <td
                width="90"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                 <p>${each.babuPitakoNaam}</p>
              </td>
              <td
                width="77"
                style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in"
              >
                 <p>${each.bajeSasuraNaam}</p>
              </td>
            </tr>`;})}
      ...
      ${props.showJaggabibaranArray?(` <p style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4">
              hUufwgL btf{ k|df0f k'hf{sf] k|ltlnkL lbg]</font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"> hUufsf] lja/0f</font></font
          >
        </p>
        ...
        ${props.showSipharisArray?(`<p style="margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4">
              hUufwgL btf{ k|df0f k'hf{sf] k|ltlnkLsf]</font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"> nflu l;kmfl/; lbg] lgsfo</font></font
          >
        </p>
        <table width="612" cellpadding="7" cellspacing="0">
          <colgroup>
            ...
            ${props.sipharisArray.map(function(each){
              ...
              >
                <p>
                  <font face="Preeti, serif"
                    ><font size="4"
                      >====${each.naam}===ufpFkflnsf÷gu/kflnsf
                      ======${each.odaNumber}======g++=j8f sfof{no</font
                    ></font
                  >
                </p>
              </td>
    ...
    <section class="sheet padding-10mm">
      ...
      <article>
        ...
        ${props.showSanglaganArray?(`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
        ...
        <p style="margin-left: 0.5in; margin-bottom: 0.11in">
          <font face="Preeti, serif"
            ><font size="4"
              >sf] r g++====${each.chanumber}====ldlt====${each.mitti}=====sf]
            </font></font
          ><font face="Preeti, serif"
            ><font size="4"
              >hUufwgL btf{ k|df0f k'hf{sf] k|ltlnkLsf]</font
            ></font
          ><font face="Preeti, serif"
            ><font size="4"> nflu l;kmfl/; kq</font></font
          >
        </p>`;
    })}
        <ul>
          ...
          <li>
            <p style="margin-bottom: 0.11in">
              <font face="Preeti, serif"
                ><font size="4">hUufwgL k|df0fk'hf{sf] em'qf]k|lt</font></font
              >
            </p>
          </li>
          <li>
        ...
        <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
          ...
          ><font face="Preeti, serif"
            ><font size="4"
              >b]xfosf] hUuf b]xfosf AolQmsf gfddf hUufwgL btf{ k|df0f k'hf{sf]
              k|ltlnkL hf/L x'g plrt b]vL lg0f{ofy{ k]z u/]sf] 5' .
            </font></font
          >
        </p>`):('')}
        ${props.showKaryalayaNirmanArray?(`<p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
        ...
        ${props.showJaggaDhaniArray?(` <p style="margin-bottom: 0.11in">
          <font face="Preeti, serif"
        ...
        <table width="612" cellpadding="7" cellspacing="0">
          ...
          <tbody>
            ...
            ${props.jaggaDhaniArray.map(function (each) {
        return `
            <tr valign="TOP">
