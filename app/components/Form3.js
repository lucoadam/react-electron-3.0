...
/>
   <div className={styles.maincontainer} data-tid="maincontainer">
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <br />
      <input type="button" name="jaggaArray-nibedakArray" onClick={this.resetTable} value="p:t} eg{'xf];\"/>
      <br />
      <br />
      <FieldArray title={['Gffd,y/',
        'Gfful/stf g+=',
      ...
      {this.state.showKaryalayanirmanArray?(<Fragment>
        <input type="button" name="gharjaggaArray-karyalayanirmanArray" onClick={this.resetTable} value="p:t} eg{'xf];\"/>
      <br/>
      <br/>
      <FieldArray title={['lhNnf',
        'Ufflj;',
