export default function returnHtml(content) {
    return(`
    <html lang="en"><head>
  <meta charset="utf-8">
  <title>A4</title>
...
"><font face="Preeti, serif" style="
      ...
      <p class="western" style="margin-bottom: 0.11in;margin-top: 0.11in;"><br><br></p>
...
float: right;
">
              ldlt @)&amp;^. .</span><br>;fFv',sf7df8f}</font></font>
      </p>
      <p align="CENTER" style="margin-bottom: 0.11in"><font face="Preeti, serif"><font size="4">ljifo
        M gfd;f/L .</font></font></p>
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">lga]bg btf{
            g++==============================</font></font>
      </p>
      <p style="margin-bottom: 0.11in">
        <a name="_GoBack"></a><font face="Preeti, serif"><font size="4">!=lga]bssf] lja/0f</font></font>
      </p>
        ...
        <tbody>
          <tr valign="TOP">
            <td width="89" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Gffd,y/</font></font>
              </p>
            </td>
            <td width="90" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Gfful/stf g+=</font></font>
              </p>
            </td>
            <td width="90" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Gfful/stf hf/L ldlt</font></font>
              </p>
            </td>
            <td width="90" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Gfful/stf hf/L lhNnf</font></font>
              </p>
            </td>
            <td width="90" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Affa'÷kltsf] gfd</font></font>
              </p>
            </td>
            <td width="77" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Affh]÷;;'/fsf] gfd</font></font>
              </p>
            </td>
          </tr>
          <tr valign="TOP">
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">@=hUUffwgLsf] lja/0f</font></font>
      </p>
      <table width="612" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="89">
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">#=gfd;f/L x'g] hUufsf] lja/0f</font></font>
      </p>
        ...
        <tbody>
          <tr valign="TOP">
            ...
            <td width="136" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Jf8f g++=÷l;6 g++=</font></font>
              </p>
            </td>
            <td width="66" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">lsQf g++</font></font>
              </p>
            </td>
            <td width="169" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">If]qkmn</font></font>
              </p>
            </td>
          </tr>
          <tr valign="TOP">
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">$= gfd;f/Lsf nflu of]Uo ;a} xsjfnfsf] laa/0f</font></font>
      </p>
      <table width="623" cellpadding="7" cellspacing="0">
        ...
        <tbody>
          <tr valign="TOP">
            ...
            <td width="83" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Affh]÷;;'/fsf] gfd</font></font>
              </p>
            </td>
            <td width="82" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">hUUffwgL;Fusf] gftf</font></font>
              </p>
            </td>
          </tr>
          <tr valign="TOP">
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">%= ck'tfnL :jLsf/ gu/L d~h'/Lgfdf lbg] xsjfnfsf] laa/0f</font></font>
      </p>
      <table width="612" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="69">
        ...
        <tbody>
          <tr valign="TOP">
            ...
            <td width="76" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Gfful/stf g+=</font></font>
              </p>
            </td>
            ...
            <td width="67" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Affa'÷kltsf] gfd</font></font>
              </p>
            </td>
            ...
            <td width="70" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">hUUffwgL;Fusf] gftf</font></font>
              </p>
            </td>
  ...
  <section class="sheet padding-10mm">
    ...
    <article>
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">^=gfd;f/Lsf] nflu l;kmfl/; lbg] lgsfo</font></font>
      </p>
      <table width="612" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="253">
        ...
        <tbody>
          <tr valign="TOP">
            <td width="253" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">lgsfosf] gfd</font></font>
              </p>
            </td>
            <td width="75" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">lhNnf</font></font>
              </p>
            </td>
            <td width="87" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">Kfqsf] r=g++</font></font>
              </p>
            </td>
            <td width="139" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
          ...
          <tr valign="TOP">
            <td width="253" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">============================ufpFkflnsf÷gu/kflnsf
                    ============g++=j8f sfof{no</font></font>
              </p>
            </td>
            <td width="75" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p><br></p>
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">&amp;=df]7 /f]Ssfsf] lja/0f M ;DalGwt df]7 kmfF6af6
            ======================================hUufsf] ;|]:tf sfod 5 /f]Ssf
            b]lvPg egL n]vL cfPsf] .</font></font>
      </p>
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">*=tfd]nLsf] Aoxf]/f M </font></font>
      </p>
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">(=;+nUg k|df0f</font></font>
      </p>
      <ul>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">==========================ufpFkflnsf÷gu/kflnsf
                =============j8f sfof{nosf] r
                g++============ldlt==================sf] gfd;f/L ls6fgL
                l;kmfl/; kq</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">hUuf wgL btf{ k|df0f kq k|ltlnkL</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">gful/stfsf] k|df0fkqsf] k|ltlnkL</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">d[To'btf{ k|df0fkqsf] k|ltlnkL</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">a]kQf ePsf] k|df0f tyf l;kmfl/;kq</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">==========================ufpFkflnsf÷gu/kflnsf
                =============j8f sfof{nosf] r
                g++============ldlt==================sf] gftf k|df0fkq</font></font>
          </p>
        </li>
        <li>
          <p style="margin-bottom: 0.11in">
            <font face="Preeti, serif"><font size="4">dfnkf]t lt/]sf] /l;b</font></font>
          </p>
        </li>
      </ul>
      <p align="JUSTIFY" style="margin-left: 0.5in; margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4">!) sfof{nosf]=lg0f{o M ldl;n ;+nUg k|df0f tyf lja/0fsf cfwf/df
            x]bf{ lgj]bs d'n'sL b]jfgL -;+lxtf</font></font><font face="Preeti, serif"><font size="4">_ P]g,@)&amp;$ sf] bkmf @#( sf] a'bf g++ =====sf] xsjfnfsf]
            k|fyldstfdf k/]sf]n] lgodfg';f/sf] gfd;f/L b:t'/ ?=============
            a'emL b]xfosf] hUuf b]xfosf AolQmsf gfddf gfd;f/L x'g plrt b]vL
            lg0f{ofy{ k]z u/]sf] 5' .
          </font></font>
      </p>
      <p style="margin-left: 0.5in; margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4"><b>gfd;f/L x'g] hUufsf] lja/0f</b></font></font>
      </p>
      <table width="618" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="89">
          <col width="68">
          <col width="136">
        ...
        <tbody>
          <tr valign="TOP">
            ...
            <td width="187" style="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
              <p>
                <font face="Preeti, serif"><font size="4">If]qkmn</font></font>
              </p>
            </td>
      ...
      <p style="margin-bottom: 0.11in">
        <font face="Preeti, serif"><font size="4"><b>gfd;f/L kl5 sfod x'g] hUufwgLsf] laa/0f</b></font></font>
      </p>
      <table width="623" cellpadding="7" cellspacing="0">
        <colgroup>
          <col width="89">
      ...
      <p style="margin-left: 0.5in; margin-bottom: 0.11in"><br><br></p>
    </article>
  </section>
